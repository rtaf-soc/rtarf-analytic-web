...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],  # 👈 or specify ["http://localhost:5173"] if you use Vite
...
def update_existing_node(
    node_id: int, 
    node: schemas.NodeUpdate,  # ✅ แก้เป็น NodeUpdate
    db: Session = Depends(get_db)
):
    """
